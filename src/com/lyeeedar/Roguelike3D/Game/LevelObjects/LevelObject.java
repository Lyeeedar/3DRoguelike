...
public abstract class LevelObject extends GameObject{
	...
	public static LevelObject checkObject(AbstractObject ao, float x, float y, float z, Level level, MonsterEvolver evolver)
	{
		...
		else if (ao.type == ObjectType.FIRE_CAMP)
		{
			...
			p.setTexture("texf", new Vector3(0.0f, 3.5f, 0.0f), 1.6f, new Colour(0.7f, 0.9f, 0.3f, 1.0f), new Colour(1.0f, 0.0f, 0.0f, 1.0f), true, 0.03f);
		...
		else if (ao.type == ObjectType.FIRE_TORCH)
		{
			...
			p.setTexture("texf", new Vector3(0.0f, 2.0f, 0.0f), 0.5f, new Colour(0.7f, 0.9f, 0.3f, 1.0f), new Colour(1.0f, 0.0f, 0.0f, 1.0f), true, 0.5f);
